...
50+50 observations here (**Note:** many samples of the positive/minority class
...
Howevver, the real data does not have the distribution of the balanced data, so 
...
**The accuracy is below the no information rate!** However,
kappa (improvement of accuracy over randomness) has increased. More importantly,
sensitivity (the
