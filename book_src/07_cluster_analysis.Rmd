...
(ARI, also called corrected Rand index)](https://en.wikipedia.org/wiki/Rand_index#Adjusted_Rand_index),
...
Read the manual page for `cluster.stats()` for an explanation of all the available indices.
