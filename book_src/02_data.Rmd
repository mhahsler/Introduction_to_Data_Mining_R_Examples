...
* [Word2vec](https://en.wikipedia.org/wiki/Word2vec) (`word2vec` in package (`word2vec`)) is used in [natural language processing](https://cran.r-project.org/web/views/NaturalLanguageProcessing.html) to convert words to numeric 
