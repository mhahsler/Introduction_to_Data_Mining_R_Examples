...
Data mining has the goal to find patterns in large data sets. In this chapter,
we will talk about data its characteristics, and how it is prepared for
data mining.
...
Features can be measured on several scales ranging from simple labels all the way to
numbers. The important scales are
