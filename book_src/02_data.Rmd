...
and many methods with varying properties exist. 
...
* [Autoencoders](https://en.wikipedia.org/wiki/Autoencoder) is a type of 
  ...
  In R, autoencoders are typically created using the `keras` package.
* [Word2vec](https://en.wikipedia.org/wiki/Word2vec) (`word2vec()` in 
  ...
  to convert words to numeric vectors for similarity calculation.
